...
function showRecommendations() {
  ...
  const scored = candidates.map(op => {
    ...
    // Base score from meta, utility, ease
    score = data.meta_score*0.4 + data.utility_score*0.35 + data.ease_score*0.25;

    // Map bonus +5 if operator is strong on selected map
